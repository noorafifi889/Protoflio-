  ...
  return (
    <section id="about" className="relative overflow-hidden py-39 md:py-40">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        {/* blobs */}
        <div className="absolute -left-40 top-[-120px] h-[520px] w-[520px] rounded-full bg-emerald-500/12 blur-3xl" />
        <div className="absolute left-[140px] top-[120px] h-[620px] w-[620px] rounded-full bg-emerald-400/10 blur-3xl" />
        <div className="absolute right-[-220px] top-[-140px] h-[700px] w-[700px] rounded-full bg-emerald-500/12 blur-3xl" />
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-start ">
            ...
            <div>
              ...
              <motion.h2
                variants={fadeUp}
                custom={1}
                className="mt-6 text-2xl  leading-tight text-white md:text-5xl"
              >
       Turning complex ideas into
<span className="text-emerald-300"> seamless experiences</span>
              </motion.h2>
            ...
            <div className="grid gap-5">
              <motion.div
                ...
                className="rounded-2xl border border-white/10 bg-white/[0.04] p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.04)] backdrop-blur-xl"
              >
                <div className="flex items-start gap-4">
                  <motion.div
                    {...floaty}
                    className="inline-flex h-11 w-11 items-center justify-center rounded-xl border border-emerald-400/20 bg-emerald-400/10 text-emerald-300"
                  >
                    <FaCode />
                  </motion.div>
                  <div>
              ...
              <motion.div
                ...
                whileHover={{ y: -6 }}
                transition={{ type: "spring", stiffness: 260, damping: 18 }}
                className="rounded-2xl border border-emerald-400/15 bg-emerald-400/5 p-5 backdrop-blur-xl"
              >
